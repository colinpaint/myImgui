...
static void ImGui_ImplDX11_CreateWindow (ImGuiViewport* viewport) {
  ...
  // PlatformHandleRaw should always be a HWND
  // whereas PlatformHandle might be a higher-level handle (e.g. GLFWWindow*, SDL_Window*).
...
static void ImGui_ImplDX11_ShutdownPlatformInterface() { ImGui::DestroyPlatformWindows(); }
